...
var server = http.createServer(function(request,response){
  ...
  if(resource =="/"){
      ...
      response.end("주소표시줄에 'localhost/images/이미지파일이름'을 입력해보세요!!!");
...
server.listen(80, function(){
    ...
    console.log('http://localhost/images/jeep1.jpg');
    console.log('http://localhost/images/jeep2.jpg');
    console.log('http://localhost/images/jeep3.jpg');
    console.log('http://localhost/images/jeep4.jpg');
